...
<head>
    ...
    <meta name="description" content="Impulse Hospital" />
    <meta name="author" content="Golpo Communications" />
                    ...
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg-overlay-black-0" style="background: url('<?php echo base_url('assets/login_page/img/bg.jpg'); ?>');">
                        <div class="login-fancy pos-r d-flex">
                            <div class="text-center w-100 align-self-center">
                                ...
                                <h2 class="text-white mb-20"><?php echo $this->db->get_where('settings', array('type' => 'system_name'))->row()->description; ?></h2><br>
                                 <h4><a href="https://golpocom.com" target="_blank">Golpo Communications</a></h4>
                            </div>
                        </div>
                    </div>
